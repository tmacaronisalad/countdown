		...
		<div class="main_con">
			<main class="example">
				...
				<div class="main-entry">
					<ul>
						<li class="l1 wow bounceInDown">100</li>
						<li class="l2 wow bounceInDown">25</li>
						<li class="l3 wow bounceInDown">75</li>
						<li class="l4 wow bounceInDown">50</li>
						<li class="l5 wow bounceInDown">3</li>
						<li class="l6 wow bounceInDown">8</li>
					</ul>
					<h3 class="wow flipInY">628</h3>
