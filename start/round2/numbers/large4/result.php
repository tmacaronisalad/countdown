			...
			<main class="result">
				...
				<div class="main-entry">
					<ul>
						...
						<li class="l2 wow bounceInDown">750 - <mark class="warning">75</mark> = 675</li>
						<li class="l3 wow bounceInDown">675 + <mark class="warning">9</mark> = <mark class="success">684</mark></li>
					</ul>
