		...
		<div class="main_con">
			<main>
				...
				<div class="main-entry">
					<ul>
						<li class="l1 wow bounceInDown">U</li>
						<li class="l2 wow bounceInDown">M</li>
						<li class="l3 wow bounceInDown">B</li>
						<li class="l4 wow bounceInDown">N</li>
						<li class="l5 wow bounceInDown">A</li>
						<li class="l6 wow bounceInDown">E</li>
						<li class="l7 wow bounceInDown">S</li>
						<li class="l8 wow bounceInDown">T</li>
						<li class="l9 wow bounceInDown">I</li>
					</ul>
