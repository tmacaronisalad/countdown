<?php
define('TITLE', 'Countdown - Round 1 - Game 1 - 5 Vowels');
			...
			<main>
				...
				<div class="main-entry">
					<ul>
						...
						<li class="l2 wow bounceInDown">R</li>
						<li class="l3 wow bounceInDown">E</li>
						<li class="l4 wow bounceInDown">O</li>
						<li class="l5 wow bounceInDown">R</li>
						<li class="l6 wow bounceInDown">T</li>
						<li class="l7 wow bounceInDown">L</li>
