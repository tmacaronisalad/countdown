			...
			<main>
				...
				<div class="main-entry">
					<ul>
						...
						<li class="l3 wow bounceInDown">18</li>
						<li class="l4 wow bounceInDown">100</li>
						<li class="l5 wow bounceInDown">8</li>
						<li class="l6 wow bounceInDown">7</li>
					</ul>
					<h3 class="wow flipInY">263</h3>
