			...
			<main>
				...
				<div class="main-entry">
					<ul>
						...
						<li class="l2 wow bounceInDown">N</li>
						<li class="l3 wow bounceInDown">U</li>
						<li class="l4 wow bounceInDown">D</li>
						<li class="l5 wow bounceInDown">E</li>
						<li class="l6 wow bounceInDown">T</li>
						<li class="l7 wow bounceInDown">A</li>
						<li class="l8 wow bounceInDown">C</li>
