		...
		<div class="main_con">
			<main>
				...
				<div class="main-entry">
					<ul>
						<li class="l1 wow bounceInDown">120</li>
						<li class="l2 wow bounceInDown">35</li>
						<li class="l3 wow bounceInDown">1</li>
						<li class="l4 wow bounceInDown">2</li>
						<li class="l5 wow bounceInDown">4</li>
						<li class="l6 wow bounceInDown">8</li>
					</ul>
					<h3 class="wow flipInY">525</h3>
