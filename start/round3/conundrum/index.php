...
<div id="main_area">
	<div class="wrapper">
		<div class="main_con">
			<main class="example">
				<h1 class="h1_title wow fadeIn">Round 3 - Game 4 - Conundrum</h1>
				<div class="main-entry">
					<ul>
						<li class="l1 wow bounceInDown">Y</li>
						...
						<li class="l7 wow bounceInDown">K</li>
						<li class="l8 wow bounceInDown">R</li>
					</ul>
					<h2 class="wow slideInRight">clatter, input</h2>
